 ...
 *
 * @param [options] - Discovery options used during the search
 ...
 * @param sitemapFile - Optional custom sitemap file path
 * @param existsSyncFn - Function to check if a path exists
 * @param resolveFn - Function to resolve paths
 ...
 * @returns File extension with dot, or empty string if none found
 *
 * @example
 ...
 * @param existsSyncFn - Function to check if file exists
 * @returns Discovery result with found status and path
 *
 * @since 0.1.0
 */
